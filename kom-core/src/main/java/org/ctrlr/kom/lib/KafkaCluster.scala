...
/**
 * This is the KafkaCluster with the proposed pull request from SPARK-10963.
 * Untill that is merged into master, this is the only way to get access
 * to these methods.
 *
 * :: DeveloperApi ::
